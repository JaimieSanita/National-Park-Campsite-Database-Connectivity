...
public class JDBCEmployeeDAO implements EmployeeDAO {
	...
	public List<Employee> getEmployeesWithoutProjects() {
		...
		String query = "SELECT * " + "FROM employee AS e "
				+ "JOIN project_employee AS pe ON e.employee_id = pe.employee_id " + "WHERE pe.project_id = ?";
		Long projectIdZero = (long) 0;
		SqlRowSet results = this.jdbcTemplate.queryForRowSet(query, projectIdZero);
