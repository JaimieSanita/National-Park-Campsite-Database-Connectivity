...
public class JDBCEmployeeDAOTest {
	...
	public void setup() {
		...
		// insert employee1
		jdbcTemplate.update(sqlInsertEmployee, EMPLOYEE_ID, DEPARTMENT_ID, EMPLOYEE_FIRST_NAME, EMPLOYEE_LAST_NAME, EMPLOYEE_BIRTHDATE,
	...
	public void returns_all_employees() {
		...
		Assert.assertEquals("There should only be two employees.", 2, actualList.size());
	...
	public void returns_employee_by_name() {
		...
		Employee expectedEmployee = getEmployee(EMPLOYEE_ID, DEPARTMENT_ID, EMPLOYEE_FIRST_NAME, EMPLOYEE_LAST_NAME, EMPLOYEE_BIRTHDATE, EMPLOYEE_GENDER, EMPLOYEE_HIRE_DATE);
	...
	public void returns_employees_by_department_id() {
		...
		Employee expectedEmployee = getEmployee(EMPLOYEE_ID2, DEPARTMENT_ID2, EMPLOYEE_FIRST_NAME2, EMPLOYEE_LAST_NAME2, EMPLOYEE_BIRTHDATE2, EMPLOYEE_GENDER2, EMPLOYEE_HIRE_DATE2);
	
		Assert.assertNotNull("An employee should be returned by department id.", actual);
		Assert.assertEquals("There should only be one employee returned.", 1, actual.size());
		assertEmployeesAreEqual(expectedEmployee, actualEmployee);
	}
