...
public class JDBCProjectTest {
	...
	private static final Long EMPLOYEE_DEPARTMENT_ID = (long) 345678912;
	private static final Long EMPLOYEE_DEPARTMENT_ID2 = (long) 345678913;
	...
	public void setup() {
		...
		//insert employee1
		jdbcTemplate.update(sqlInsertEmployee, EMPLOYEE_ID, EMPLOYEE_FIRST_NAME, EMPLOYEE_LAST_NAME, EMPLOYEE_BIRTHDATE, EMPLOYEE_GENDER, EMPLOYEE_HIRE_DATE);
		
		//insert employee2
		jdbcTemplate.update(sqlInsertEmployee, EMPLOYEE_ID2, EMPLOYEE_FIRST_NAME2, EMPLOYEE_LAST_NAME2, EMPLOYEE_BIRTHDATE2, EMPLOYEE_GENDER2, EMPLOYEE_HIRE_DATE2);
		
		//insert join1
		//jdbcTemplate.update(sqlInsertJoin, PROJECT_ID, EMPLOYEE_ID);
		
		//insert join2
		//jdbcTemplate.update(sqlInsertJoin, PROJECT_ID2, EMPLOYEE_ID2);
	...
	public void returns_all_projects() {
		...
		Assert.assertEquals("There should only be one active project.",
							1,
							actualList.size());
	}
	...
	public void adds_employee_to_project() {
		...
		Assert.assertEquals("Two employees should have been added.",
							2,
							actual.size());
	}
	//fake employee
	private Employee getEmployee(String first_name, String last_name, LocalDate birthDay, char gender, LocalDate hireDate) {
